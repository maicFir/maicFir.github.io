...
<p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/e314ada63ecb4f95932acbf5c492331d~tplv-k3u1fbpfcp-zoom-1.image" alt=""></p>
...
<p>注意我们给所有的子元素加了浮动，那么此时会造成父元素高度坍塌，因此父级元素必须要加上<code v-pre>overflow:hidden</code>或者设置<code v-pre>display: inlie-block</code>或者<code v-pre>position: absolute</code>;这样才可以导致父级元素不坍塌。</p>
...
<p>我们最初把<code v-pre>margin</code>作用在每个小元素下，现在我们利用<code v-pre>BFC</code>的特性，我们把<code v-pre>margin</code>作用在<code v-pre>item</code>上，因为三个<code v-pre>item</code>就是相邻垂直方向的 BFC 结构,边距会产生合并，也正是利用边距合并巧妙的解决了保持边距相等的问题。</p>
<p>具体可以看下效果
