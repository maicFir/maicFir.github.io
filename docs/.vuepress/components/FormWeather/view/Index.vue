...
<script>
/**
 * 参考来源：https://github.com/itclanCode/blogcode/blob/master/docs/.vuepress/components/form/weather.vue
 */
...
export default {
  ...
  data() {
    return {
      color: "#409eff",
      str: "", // 定义拼接的字符串变量
      src: "https://tianqiapi.com/api.php?style=tz&skin=apple&cityid=101280601",
    };
  },
  ...
  methods: {
    welcomeTime() {
      ...
      if (hour < 12) {
        ...
        this.str =
          "Hi,夜猫子好,熬最晚的夜,敷最贵的膜,不要熬夜哦,没了1,后面再多的零,也没有意义哈,狗命要紧";
        this.color = "#f56c6c";
      }
    },
  },
